...
public class CodeImage2 {
    ...
    private static BufferedImage scale(String srcImageFile, int height, int width, boolean hasFiller) throws IOException {
        ...
        if ((srcImage.getHeight() > height) || (srcImage.getWidth() > width)) {
            ...
            //System.out.println(scale(file.getName(),height,width,hasFiller));
    ...
    public static void main(String[] args) {
        //第一个参数是扫二维码以后出现的页面路径，第二个参数是长度，第三个参数是图片，第四个参数是将第三个填空的图片放入二维码中
        CodeImage2.encode("https://www.qichacha.com/firm_617e132af09e76373fca952526de5599", 300, 300, "e:/bb/785976644054225399.png", "e:/bb/m2.jpg");
    }
